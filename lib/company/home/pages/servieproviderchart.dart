...
class Charts extends ConsumerStatefulWidget {
  ...
  Charts({Key? key, required this.grapData}) : super(key: key);

  @override
  ConsumerState<Charts> createState() => _ChartState();
}

class _ChartState extends ConsumerState<Charts> {
  ...
  Widget build(BuildContext context) {
    for (var element in widget.grapData!.toList()) {
