...
class DownloadWidget extends StatefulWidget with WidgetsBindingObserver {
  final TargetPlatform? platform;

  DownloadWidget({Key? key, this.title, this.platform}) : super(key: key);
...
class _DownloadWidgetState extends State<DownloadWidget> {
  ...
  Future<void> _prepare() async {
    ...
    _tasks!.add(_TaskInfo(name: _documents['name'], link: _documents['link']));
