...
class CompanyEditProfile extends ConsumerStatefulWidget {
  CompanyEditProfile({
    Key? key,
  }) : super(key: key);

  @override
  ConsumerState<CompanyEditProfile> createState() => _CompanyEditProfileState();
}

class _CompanyEditProfileState extends ConsumerState<CompanyEditProfile> {
  ...
  TextEditingController websiteController = TextEditingController(
      text: userData != null ? userData!.companyLink : "");
  TextEditingController yourFullController = TextEditingController(
      text: userData != null ? userData!.yourFullName : "");
  TextEditingController address2Controller = TextEditingController(
      text: userData != null ? userData!.addressLine2 : "");
  TextEditingController designationController = TextEditingController(
      text: userData != null ? userData!.yourDesignation : "");
  TextEditingController linkdinId =
      TextEditingController(text: userData != null ? userData!.linkdinId : "");
  ...
  setDataOfStaff() {
    ...
    addressController.text = userData!.addressLine1 ?? '';
    address2Controller.text = userData!.addressLine2 ?? '';
    designationController.text = userData!.yourDesignation ?? '';
    selectedState = userData!.companyData!.state;
    selectedCity = userData!.companyData!.city;
    setState(() {});
  }
  ...
  saveRegisterEditProfile({
    ...
    bool isCompany = userData!.userRoleType == RoleTypeConstant.company;
    if (isCompany) {
      editData['company_link'] = websiteLink;
      editData['your_full_name'] = fullName;
      editData["email"] = userData!.email;
      editData['your_designation'] = designation;
      editData['industry_id'] = industryId;
    } else {
      editData["gender"] = gender.toString().toLowerCase();
      editData['your_designation'] = designation;
      editData["dob"] = dob;
      editData['linkedIn_id'] = linkdinId;
    }
    if (image != null) {
    ...
    ApiResponse response = isCompany
        ? await editCompanyProfile(editData)
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CompanyAppBar(
        back: 'HOME (COMPANY ADMIN) / EDIT PROFILE',
        ...
        !Responsive.isDesktop(context)
            ? Column(
                children: [
                  ...
                  if (isCompany)
                    TextEditable(
                        label: LabelString.companyWebsite,
                  ...
                  if (selectedState != null && state.isNotEmpty)
                    isCompany
                  ...
                  if (!isCompany)
                    Padding(
                      ...
                      child: TextEditable(
                          label: LabelString.linkdinId, controller: linkdinId),
                    ),
                  if (isCompany)
                    TextEditable(
                        label: LabelString.fullName,
                        controller: yourFullController),
                  NonEditableTextField(
                      label: LabelString.myDesignation,
                  ...
                  SubmitElevatedButton(
                    ...
                    onSubmit: () async {
                      ...
                      await saveRegisterEditProfile(
                          ...
                          fullName: yourFullController.text,
                          websiteLink: websiteController.text,
                          linkdinId: linkdinId.text);
                    },
                  )
                ],
              )
