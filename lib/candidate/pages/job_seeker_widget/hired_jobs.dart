...
class HiredJobs extends ConsumerStatefulWidget {
  HiredJobs({Key? key}) : super(key: key);

  @override
  _HiredJobsState createState() => _HiredJobsState();
}

class _HiredJobsState extends ConsumerState<HiredJobs> {
  @override
  void initState() {
    super.initState();
    ref.read(jobData).fetchHiredJobs(context);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer(builder: (context, ref, child) {
      List<JobsTwo> jobs = ref.watch(jobData).hiredJobs;
      return IntrinsicHeight(
        child: PaginationJobs(
          flag: 'hired',
          cardState: CardState.hired,
