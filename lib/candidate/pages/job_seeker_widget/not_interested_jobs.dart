...
class NotInterestedJobs extends ConsumerStatefulWidget {
  NotInterestedJobs({Key? key}) : super(key: key);

  @override
  _NotInterestedJobsState createState() => _NotInterestedJobsState();
}

class _NotInterestedJobsState extends ConsumerState<NotInterestedJobs> {
  @override
  void initState() {
    super.initState();
    ref.read(jobData).fetchNotInterestedJob(context);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer(builder: (context, ref, child) {
      List<JobsTwo> jobs = ref.watch(jobData).notInterestedJobs;
      return IntrinsicHeight(
        child: PaginationJobs(
          flag: '',
          cardState: CardState.notInterested,
          ...
          getJobsList: (page,sortByRelevance) =>
              ref.read(jobData).fetchNotInterestedJob(context, page: page,sortByRelevance:sortByRelevance),
        ),
      );
    });
    // : ListView(
